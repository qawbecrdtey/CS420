...
struct construct_vector<Type, T, Args...> {
	...
	static void func(std::vector<Type> &v, T &&arg, Args&&... args) {
...
struct construct_vector<Type> {
	static void func(std::vector<Type> &) {}
...
struct syntax_tree_node {
	...
	syntax_tree_node(Args&&... args) {
		construct_vector<std::unique_ptr<syntax_tree_node>, Args...>::func(children, args...);
	}
